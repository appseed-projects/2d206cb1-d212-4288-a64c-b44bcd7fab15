...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-22 15:19`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/2d206cb1-d212-4288-a64c-b44bcd7fab15.git
$ cd 2d206cb1-d212-4288-a64c-b44bcd7fab15
```
